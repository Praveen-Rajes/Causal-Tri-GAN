...
The framework uses three generators: G1 GAN for image synthesis achieving FID 26.28 on CheXpert, G2 (U-Net with Attention Gates and FiLM conditioning) for heatmap generation achieving causal necessity of 0.979 with 7.6% sparsity, and G3 (frozen  but finetunedViT-BERT) for report generation achieving BLEU-1 of 0.2197 and ROUGE-L of 0.2216. Training follows a three-phase progressive strategy with a causal intervention loss grounded in Pearl's interventional framework.
